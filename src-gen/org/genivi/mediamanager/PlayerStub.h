...
class PlayerStubAdapter: virtual public CommonAPI::StubAdapter, public Player {
 public:
    ...
    virtual void fireMuteAttributeChanged(const PlayerTypes::MuteStatus& mute) = 0;
    ///Notifies all remote listeners about a change of value of the attribute shuffle.
    virtual void fireShuffleAttributeChanged(const PlayerTypes::ShuffleStatus& shuffle) = 0;
    ...
    virtual void firePlaybackStatusAttributeChanged(const PlayerTypes::PlaybackStatus& playbackStatus) = 0;
...
class PlayerStubRemoteEvent {
 public:
    ...
    virtual bool onRemoteSetMuteAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, PlayerTypes::MuteStatus mute) = 0;
    ...
    virtual bool onRemoteSetShuffleAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, PlayerTypes::ShuffleStatus shuffle) = 0;
    ...
    virtual bool onRemoteSetRepeatAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, PlayerTypes::RepeatStatus repeat) = 0;
 ...
 * a look at if he wants to implement a service.
 */
class PlayerStub: public virtual CommonAPI::Stub<PlayerStubAdapter, PlayerStubRemoteEvent> {
public:
    virtual ~PlayerStub() { }
    ...
    virtual const PlayerTypes::MuteStatus& getMuteAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) = 0;
    /**
    ...
    virtual const PlayerTypes::ShuffleStatus& getShuffleAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) = 0;
    /**
    ...
    virtual const PlayerTypes::RepeatStatus& getRepeatAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) = 0;
    /**
    ...
    virtual const PlayerTypes::PlaybackStatus& getPlaybackStatusAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) = 0;
    /**
    ...
    virtual const uint64_t& getDurationAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) = 0;
    ...
    virtual void next(const std::shared_ptr<CommonAPI::ClientId> clientId, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void openUri(const std::shared_ptr<CommonAPI::ClientId> clientId, std::string uri, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void enqueueUri(const std::shared_ptr<CommonAPI::ClientId> clientId, std::string uri, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void dequeueAll(const std::shared_ptr<CommonAPI::ClientId> clientId, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void openPlaylist(const std::shared_ptr<CommonAPI::ClientId> clientId, std::string uri, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void pause(const std::shared_ptr<CommonAPI::ClientId> clientId, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void play(const std::shared_ptr<CommonAPI::ClientId> clientId, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void playPause(const std::shared_ptr<CommonAPI::ClientId> clientId, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void previous(const std::shared_ptr<CommonAPI::ClientId> clientId, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void seek(const std::shared_ptr<CommonAPI::ClientId> clientId, int64_t pos, PlayerTypes::PlayerError& e) = 0;
    /**
    ...
    virtual void setPosition(const std::shared_ptr<CommonAPI::ClientId> clientId, uint64_t pos, PlayerTypes::PlayerError& e) = 0;
