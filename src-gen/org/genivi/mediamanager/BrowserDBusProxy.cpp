 ...
 */
void BrowserDBusProxy::listContainers(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, CommonAPI::CallStatus& callStatus, std::string& containers, BrowserTypes::BrowserError& e) {
 ...
 */
void BrowserDBusProxy::listContainersEx(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const BrowserTypes::SortKey& sortKey, CommonAPI::CallStatus& callStatus, std::string& containers, BrowserTypes::BrowserError& e) {
 ...
 * @param filter: Array of keys to include in resulting JSON elements
 */
void BrowserDBusProxy::listItems(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, CommonAPI::CallStatus& callStatus, std::string& items, BrowserTypes::BrowserError& e) {
    CommonAPI::DBus::DBusProxyHelper<CommonAPI::DBus::DBusSerializableArguments<std::string, uint64_t, uint64_t, std::vector<std::string>>,
                                     CommonAPI::DBus::DBusSerializableArguments<std::string, BrowserTypes::BrowserError> >::callMethodWithReply(
        *this,
        "listItems",
 ...
 * @param sortKey Key to sort JSON result list on
 */
void BrowserDBusProxy::listItemsEx(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const BrowserTypes::SortKey& sortKey, CommonAPI::CallStatus& callStatus, std::string& items, BrowserTypes::BrowserError& e) {
    CommonAPI::DBus::DBusProxyHelper<CommonAPI::DBus::DBusSerializableArguments<std::string, uint64_t, uint64_t, std::vector<std::string>, BrowserTypes::SortKey>,
                                     CommonAPI::DBus::DBusSerializableArguments<std::string, BrowserTypes::BrowserError> >::callMethodWithReply(
        *this,
        "listItemsEx",
 ...
 * @param filter: Array of keys to include in resulting JSON elements
 */
void BrowserDBusProxy::listChildren(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, CommonAPI::CallStatus& callStatus, std::string& children, BrowserTypes::BrowserError& e) {
    CommonAPI::DBus::DBusProxyHelper<CommonAPI::DBus::DBusSerializableArguments<std::string, uint64_t, uint64_t, std::vector<std::string>>,
                                     CommonAPI::DBus::DBusSerializableArguments<std::string, BrowserTypes::BrowserError> >::callMethodWithReply(
        *this,
        "listChildren",
 ...
 * @param sortKey Key to sort JSON result list on
 */
void BrowserDBusProxy::listChildrenEx(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const BrowserTypes::SortKey& sortKey, CommonAPI::CallStatus& callStatus, std::string& children, BrowserTypes::BrowserError& e) {
    CommonAPI::DBus::DBusProxyHelper<CommonAPI::DBus::DBusSerializableArguments<std::string, uint64_t, uint64_t, std::vector<std::string>, BrowserTypes::SortKey>,
                                     CommonAPI::DBus::DBusSerializableArguments<std::string, BrowserTypes::BrowserError> >::callMethodWithReply(
        *this,
        "listChildrenEx",
 ...
 * @param filter: Array of keys to include in resulting JSON elements
 */
void BrowserDBusProxy::searchObjects(const std::string& path, const std::string& query, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, CommonAPI::CallStatus& callStatus, std::string& objects, BrowserTypes::BrowserError& e) {
 ...
 * @param sortKey Key to sort JSON result list on
 */
void BrowserDBusProxy::searchObjectsEx(const std::string& path, const std::string& query, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const BrowserTypes::SortKey& sortKey, CommonAPI::CallStatus& callStatus, std::string& objects, BrowserTypes::BrowserError& e) {
