...
,mute_(*this, "onMuteAttributeChanged", "setMuteAttribute", "u", "getMuteAttribute"),
shuffle_(*this, "onShuffleAttributeChanged", "setShuffleAttribute", "u", "getShuffleAttribute"),
repeat_(*this, "onRepeatAttributeChanged", "setRepeatAttribute", "u", "getRepeatAttribute"),
rate_(*this, "onRateAttributeChanged", "setRateAttribute", "u", "getRateAttribute"),
...
playbackStatus_(*this, "onPlaybackStatusAttributeChanged", "u", "getPlaybackStatusAttribute"),
 ...
 */
void PlayerDBusProxy::openUri(const std::string& uri, CommonAPI::CallStatus& callStatus, Player::PlayerError& e) {
 ...
 *              NO_ERROR     On success
 */
void PlayerDBusProxy::openPlaylist(const std::string& uri, CommonAPI::CallStatus& callStatus, Player::PlayerError& e) {
    CommonAPI::DBus::DBusProxyHelper<CommonAPI::DBus::DBusSerializableArguments<std::string>,
                                     CommonAPI::DBus::DBusSerializableArguments<Player::PlayerError> >::callMethodWithReply(
        *this,
        "openPlaylist",
