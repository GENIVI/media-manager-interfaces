...
virtual const Player::MuteStatus& getMuteAttribute() = 0 ;
...
const Player::MuteStatus& getMuteAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) {
    return getMuteAttribute();
}

void setMuteAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, Player::MuteStatus value) {
    setMuteAttribute(value);
}

virtual void setMuteAttribute(Player::MuteStatus value) = 0;


virtual const Player::ShuffleStatus& getShuffleAttribute() = 0 ;
...
const Player::ShuffleStatus& getShuffleAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) {
    return getShuffleAttribute();
}

void setShuffleAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, Player::ShuffleStatus value) {
    setShuffleAttribute(value);
}

virtual void setShuffleAttribute(Player::ShuffleStatus value) = 0;


virtual const Player::RepeatStatus& getRepeatAttribute() = 0 ;
...
const Player::RepeatStatus& getRepeatAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) {
    return getRepeatAttribute();
}

void setRepeatAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, Player::RepeatStatus value) {
    setRepeatAttribute(value);
}

virtual void setRepeatAttribute(Player::RepeatStatus value) = 0;


virtual const Player::RateStatus& getRateAttribute() = 0 ;
...
const Player::RateStatus& getRateAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) {
    return getRateAttribute();
}

void setRateAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, Player::RateStatus value) {
    setRateAttribute(value);
}

virtual void setRateAttribute(Player::RateStatus value) = 0;
...
virtual const Player::PlaybackStatus& getPlaybackStatusAttribute() = 0 ;
...
const Player::PlaybackStatus& getPlaybackStatusAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId) {
...
virtual void openUri(std::string uri, Player::PlayerError& e) = 0;
 ...
 */
virtual void enqueueUri(const std::shared_ptr<CommonAPI::ClientId> clientId, std::string uri, Player::PlayerError& e) {
    // Call old style methods in default 
    return enqueueUri(uri, e);
}
virtual void enqueueUri(std::string uri, Player::PlayerError& e) = 0;
 ...
 */
virtual void dequeueIndex(const std::shared_ptr<CommonAPI::ClientId> clientId, uint64_t pos, Player::PlayerError& e) {
    // Call old style methods in default 
    return dequeueIndex(pos, e);
}
virtual void dequeueIndex(uint64_t pos, Player::PlayerError& e) = 0;
 ...
 */
virtual void getCurrentPlayQueue(const std::shared_ptr<CommonAPI::ClientId> clientId, std::string& playQueue, Player::PlayerError& e) {
    // Call old style methods in default 
...
virtual void openPlaylist(std::string uri, Player::PlayerError& e) = 0;
...
bool onRemoteSetMuteAttribute(Player::MuteStatus value) {
...
bool onRemoteSetMuteAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, Player::MuteStatus value) {
...
bool onRemoteSetShuffleAttribute(Player::ShuffleStatus value) {
    defaultStub_->setShuffleAttribute(value);
    return false;	// We let the service implementation take care of triggering the "property changed"" notifications
}

bool onRemoteSetShuffleAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, Player::ShuffleStatus value) {
...
bool onRemoteSetRepeatAttribute(Player::RepeatStatus value) {
    defaultStub_->setRepeatAttribute(value);
    return false;	// We let the service implementation take care of triggering the "property changed"" notifications
}

bool onRemoteSetRepeatAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, Player::RepeatStatus value) {
...
bool onRemoteSetRateAttribute(Player::RateStatus value) {
    defaultStub_->setRateAttribute(value);
    return false;	// We let the service implementation take care of triggering the "property changed"" notifications
}

bool onRemoteSetRateAttribute(const std::shared_ptr<CommonAPI::ClientId> clientId, Player::RateStatus value) {
