...
class BrowserProxy: virtual public Browser, virtual public BrowserProxyBase, public _AttributeExtensions... {
 public:
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::listContainers(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, CommonAPI::CallStatus& callStatus, std::string& containers, Browser::BrowserError& e) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::listContainersEx(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, CommonAPI::CallStatus& callStatus, std::string& containers, Browser::BrowserError& e) {
    delegate_->listContainersEx(path, offset, count, filter, sortKey, callStatus, containers, e);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> BrowserProxy<_AttributeExtensions...>::listContainersExAsync(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, ListContainersExAsyncCallback callback) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::listItems(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, CommonAPI::CallStatus& callStatus, std::string& items, Browser::BrowserError& e) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::listItemsEx(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, CommonAPI::CallStatus& callStatus, std::string& items, Browser::BrowserError& e) {
    delegate_->listItemsEx(path, offset, count, filter, sortKey, callStatus, items, e);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> BrowserProxy<_AttributeExtensions...>::listItemsExAsync(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, ListItemsExAsyncCallback callback) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::listChildren(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, CommonAPI::CallStatus& callStatus, std::string& children, Browser::BrowserError& e) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::listChildrenEx(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, CommonAPI::CallStatus& callStatus, std::string& children, Browser::BrowserError& e) {
    delegate_->listChildrenEx(path, offset, count, filter, sortKey, callStatus, children, e);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> BrowserProxy<_AttributeExtensions...>::listChildrenExAsync(const std::string& path, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, ListChildrenExAsyncCallback callback) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::searchObjects(const std::string& path, const std::string& query, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, CommonAPI::CallStatus& callStatus, std::string& objects, Browser::BrowserError& e) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::searchObjectsEx(const std::string& path, const std::string& query, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, CommonAPI::CallStatus& callStatus, std::string& objects, Browser::BrowserError& e) {
    delegate_->searchObjectsEx(path, query, offset, count, filter, sortKey, callStatus, objects, e);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> BrowserProxy<_AttributeExtensions...>::searchObjectsExAsync(const std::string& path, const std::string& query, const uint64_t& offset, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, SearchObjectsExAsyncCallback callback) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::listIndexes(const std::string& container, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, CommonAPI::CallStatus& callStatus, std::string& indexes, Browser::BrowserError& e) {
    delegate_->listIndexes(container, count, filter, sortKey, callStatus, indexes, e);
}

template <typename ... _AttributeExtensions>
std::future<CommonAPI::CallStatus> BrowserProxy<_AttributeExtensions...>::listIndexesAsync(const std::string& container, const uint64_t& count, const std::vector<std::string>& filter, const Browser::SortKey& sortKey, ListIndexesAsyncCallback callback) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::createContainer(const std::string& path, const std::string& displayName, const std::vector<std::string>& childTypes, CommonAPI::CallStatus& callStatus, std::string& pathIdentifier, Browser::BrowserError& e) {
 ...
 */
template <typename ... _AttributeExtensions>
void BrowserProxy<_AttributeExtensions...>::createReference(const std::string& path, const std::string& objectPath, CommonAPI::CallStatus& callStatus, std::string& pathIdentifier, Browser::BrowserError& e) {
